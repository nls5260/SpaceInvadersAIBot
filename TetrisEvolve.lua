...
function getInputs()
        currPieceX = memory.readbyte(0x0040)
        currPieceY = memory.readbyte(0x0041)
        currPieceID = memory.readbyte(0x0042)
        nextPieceID = memory.readbyte(0x00BF)

        local inputs = {}
        inputs[0] = currPieceX
        inputs[1] = currPieceY
        inputs[2] = currPieceID
        inputs[3] = nextPieceID

        counter = 0
        while counter < 200 do
                inputs[counter+4] = memory.readbyte(0x0400 + counter)
                counter = counter + 1
        end
